...
- The 2017 workflow files now live under `strategy_2017/`.
- The commands below assume your working directory is `strategy_2017`.
...
- `sh000300.csv`
  CSI 300 benchmark input. The script looks first in `strategy_2017/akshare_index_data/` and then in the repo-root `akshare_index_data/`.
- `sh000012.csv`
  SSE Treasury benchmark input. The script looks first in `strategy_2017/akshare_index_data/` and then in the repo-root `akshare_index_data/`.
...
- Strategy Ann. Return: `4.53%`
- Benchmark Ann. Return: `0.95%`
- Strategy Volatility: `5.96%`
- Benchmark Volatility: `21.66%`
- Strategy Sharpe: `0.77`
- Benchmark Sharpe: `0.15`
- Strategy Max Drawdown: `-12.33%`
- Benchmark Max Drawdown: `-35.29%`
- Monthly Hit Rate: `51.09%`
- Rebalance Months: `92`
...
- Strategy Ann. Return: `4.64%`
- Benchmark Ann. Return: `0.95%`
- Strategy Volatility: `4.81%`
- Benchmark Volatility: `21.66%`
